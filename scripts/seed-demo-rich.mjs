...
async function main() {
  ...
  console.log('\n📊 Expected patterns:')
  console.log('  1. Post-Purchase NPS: Shipping anomaly spike in last 20 responses')
  console.log('  2. Support CSAT: Sentiment declining over time')
  console.log('  3. Website CES: Sudden improvement after "redesign" (response 75+)')
  console.log('  4. Product Quality: Bimodal distribution (love it or hate it)')
  console.log('  5. Onboarding NPS: Steadily improving scores over time')
}
