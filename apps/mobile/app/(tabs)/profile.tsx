  ...
  return (
    <ScrollView style={{ flex: 1, backgroundColor: '#f8fafc' }} contentContainerStyle={{ paddingTop: insets.top + 8, paddingBottom: 32 }}>
      ...
      <Text style={s.aiDisclosure}>
        Insights, clustering, and anomaly detection are generated by AI. Results are informational and should be reviewed alongside your own judgment.
      </Text>
...
const s = StyleSheet.create({
  ...
  aiDisclosure: { fontSize: 11, color: '#9ca3af', textAlign: 'center', marginHorizontal: 20, marginTop: 8, marginBottom: 24, lineHeight: 16 },
})
