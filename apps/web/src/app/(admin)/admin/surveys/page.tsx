...
function CopyWidgetButton({ surveyId }: { surveyId: string }) {
  ...
  return (
    <button
      ...
      className="inline-flex items-center gap-1 rounded border border-gray-300 px-2 py-1 text-xs font-medium text-gray-600 hover:bg-gray-50 transition-colors"
    >
