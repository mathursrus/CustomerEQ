...
export function Step6Budget({
  ...
  const [noBudgetError, setNoBudgetError] = useState(false)
      ...
      <div className="bg-white border border-slate-200 rounded-xl p-6 space-y-6">
        ...
        <div className="grid grid-cols-2 gap-4">
          <div>
            ...
            {noBudgetError
              ? <p className="mt-1 text-xs text-red-500">Total budget is required.</p>
              : <p className="mt-1 text-xs text-slate-500">Hard cap on total points value issued.</p>
            }
          </div>
          <div>
            <label className="block text-sm font-medium text-slate-700 mb-1.5">
