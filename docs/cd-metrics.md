...
_Last updated: 2026-05-24 02:18 UTC by the [cd-metrics workflow](../.github/workflows/cd-metrics.yml)_

## 30-Day Summary

| Metric | Value | Status |
|--------|-------|--------|
| CD P50 wall clock | 13m 0s | ✅ |
| CD P90 wall clock | 17m 11s | ✅ |
| Merge → live P50 | 24m 58s | ✅ |
| Merge → live P90 | 37m 55s ⚠️ | ⚠️ |
| CD success rate (7d) | 56% ⚠️ | ⚠️ |
| Deploys analysed (30d) | 172 | — |
